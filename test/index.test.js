...
describe("Lançamento de Notas", () => {
    ...
    test('Deve lançar um erro se a entrada de 1UP não for um número', () => {
      ...
      test('Deve lançar um erro se a entrada de 2UP não for um número', () => {
        expect(() => lancarNota( 7.5, "sete")).toThrow("A nota de 2UP deve ser um número entre 0.0 e 10.0 com uma casa decimal."
          );
        });
  });